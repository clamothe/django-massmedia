...
IMAGE_EXTS = ('bmp', 'gif', 'ico', 'cur', 'jpg', 'jpeg', 'pcx',
              'png', 'psd', 'tga', 'tiff', 'wmf', 'xcf', 'bmp',
              'wmf', 'apm', 'emf')

VIDEO_EXTS = ('asf', 'wmv', 'flv', 'mov', 'mpeg', 'mpg', 'mpe',
              'vob', 'qt', 'mp4', 'm4v', 'rm', 'avi', 'ogm')

AUDIO_EXTS = ('asf', 'aif', 'aiff', 'aifc', 'flac', 'au', 'snd',
              'mid', 'midi', 'mpa', 'm4a', 'mp1', 'mp2', 'mp3',
              'ra', 'xm', 'wav', 'ogg')
